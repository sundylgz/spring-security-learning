package com.sundy.security.web.controller;
...
public class UserControllerTest {
    ...
    public void whenUploadSuccess() throws Exception {
        String result = mockMvc.perform(fileUpload("/file").file(new MockMultipartFile("file", "test.txt", "multipart/form-data", "test".getBytes("UTF-8"))))
    ...
    public void whenQuerySuccess() throws Exception {
        String result = mockMvc.perform(get("/user")
                ...
                // .param("page", "3")
                // .param("sort", "age,desc"))
                .param("xxx", "yyy").contentType(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(status().isOk())
    ...
    public void whenDeleteSuccess() throws Exception {
        String reuslt = mockMvc.perform(delete("/user/1")
                .contentType(MediaType.APPLICATION_JSON_UTF8))
